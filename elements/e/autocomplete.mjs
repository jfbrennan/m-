export default function Autocomplete({ html }) {
  return html`
<style scope=global>
/* Base styles */
e-autocomplete {
  ...
  & > div {
    ...
    & > ul li:hover { background-color: var(--e-color-gray-1) }
  }
}

/* When paired with label */
fieldset label + e-autocomplete { margin-top: var(--e-space-xs) }

</style>
<script type=module >

class EdashAutocomplete extends HTMLElement {
  #initialized = false;
  #boundClose;
  #input;
  #matches;
...
customElements.define('e-autocomplete', EdashAutocomplete);
</script>
  `
}
